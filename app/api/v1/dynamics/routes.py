...
from app.api.v1.dynamics import dynamic_field_controller
...
dynamic_fields_bp.get("/<string:entity_type>")(dynamic_field_controller.get_entity_fields)

# Crear una nueva definición de campo
dynamic_fields_bp.post("/")(dynamic_field_controller.create_field)
