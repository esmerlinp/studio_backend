...
from app.api.v1.users.controller import get_user, get_users, create_user, me, get_user_by_name, change_password, forgot_password, add_user_preferences, update_user_preferences
...
#PREFERENCES
users_bp.post("/preferences/default")(add_user_preferences) 
