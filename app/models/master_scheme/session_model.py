...
class Session(db.Model):
    ...
    refreshToken = db.Column('srefreshtoken', db.String(500), nullable=True)
    expirationDate = db.Column('dfechaexpiracion',db.DateTime(timezone=True), nullable=True)
    lastAccessDate = db.Column('dultimoacceso', db.DateTime(timezone=True), nullable=True)
    ...
    latitude = db.Column('nlatitud', db.Numeric(10, 8), nullable=True)
    longitude = db.Column('nlongitud',db.Numeric(11, 8), nullable=True)
